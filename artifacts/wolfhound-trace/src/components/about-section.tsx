    ...
    <section ref={sectionRef} id="about" className="relative py-32 pl-6 md:pl-28 pr-6 md:pr-12">
      <div ref={headerRef} className="mb-12">
        ...
        <ul className="mt-6 space-y-2 font-mono text-xs md:text-sm">
          {[["#our-purpose", "Our Purpose"], ["#evidence-led", "Evidence-Led Investigative Support"], ["#osint-expertise", "OSINT Expertise in Practice"], ["#who-we-support", "Who We Support"], ["#digital-safety", "Commitment to Digital Safety"], ["#get-in-touch", "Get in Touch"]].map(([href, label]) => (
      ...
      <div ref={contentRef} className="max-w-3xl">
        <p className="font-mono text-sm md:text-base text-muted-foreground leading-relaxed mb-4">WolfhoundTrace Investigations was founded to help businesses, institutions, and individuals uncover risk, verify facts, and respond to uncertainty with confidence.</p>
        ...
        <p className="font-mono text-sm md:text-base text-muted-foreground leading-relaxed mb-6">If you or your organisation are facing suspicious behaviour, require investigative insight, or need guidance on online harm and risk-related issues, we encourage you to reach out.</p>
